      ...
      if (Y.Squarespace.Template.getTweakValue('thumbnail-layout') != 'Autocolumns') {
        ...
        var galleryValues = function () {
          ...
          return {
            ...
            width: Math.max(1, parseInt(Y.Squarespace.Template.getTweakValue('TMaxWidth'), 10))
          };
        };
    ...
    Y.all('#projectThumbs a.project').each(Y.bind(function(elem) {
      ...
      if (projPage && projPage.hasClass('page-project')) {
        dynamicLoaders['#'+href] = new Y.Squarespace.DynamicData({
            ...
            // This key used to say this. It was causing bugs in IE.
            // I (Foley) removed the ternary operator and it seems
            // to be working fine. However, I chose to leave this
            // old key here in case it's needed for some reason. In
            // the future, please comment anytime you make a browser
            // specific bug fix.
